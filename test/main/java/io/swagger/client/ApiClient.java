...
public class ApiClient {
    ...
    private String basePath = "http://192.168.50.56:8080/football/wemedia";
        ...
        if (contentType.startsWith("multipart/form-data")) {
            ...
            for (Entry<String, Object> param : formParams.entrySet()) {
                if (param.getValue() instanceof File) {
                    ...
                    mp.bodyPart(
                            new FileDataBodyPart(param.getKey(), file, MediaType.MULTIPART_FORM_DATA_TYPE));
                } else {
    ...
    public <T> T invokeAPI(String path, String method, List<Pair> queryParams, Object body,
        ...
        ClientResponse response = getAPIResponse(path, method, queryParams, body, headerParams, formParams,
